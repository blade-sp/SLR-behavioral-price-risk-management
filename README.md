...
1. (Optional) The file "IncludedStudies_FinalList.ris" contains the reference list of studies included
    in the literature review. You can direclty import this file to your preferred reference manager.
